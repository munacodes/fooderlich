...
class MockService {
  ...
  // Adds create and load methods
  void create() {
    loadRecipes();
  }

  void loadRecipes() async {
    var jsonString = await rootBundle.loadString('assets/images/recipes1.json');
    _currentRecipes1 = APIRecipeQuery.fromJson(
      jsonDecode(jsonString),
    );
    jsonString = await rootBundle.loadString('assets/images/recipes2.json');
    _currentRecipes2 = APIRecipeQuery.fromJson(
      jsonDecode(jsonString),
    );
